...
int main(int argc, char** argv) {
	...
	for(j = 0; j < repeat; j++) {
		if      (strcmp(access_mode, "rpc")==0) 	read_counters_rpc(dump, power_smoothing);
		else if (strcmp(access_mode, "mmio")==0) 	read_counters_mmio();
		else if (strcmp(access_mode, "prof")==0) 	profile_through_opencl();
	}
