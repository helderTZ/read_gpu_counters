...
define cc76 void @vect2_sp_add_kernel(<2 x float> addrspace(1)* nocapture %a, <2 x float> addrspace(1)* nocapture %b) nounwind {
  ...
  %2 = getelementptr inbounds <2 x float> addrspace(1)* %a, i32 %1
  %3 = load <2 x float> addrspace(1)* %2, align 8, !tbaa !10
  %4 = getelementptr inbounds <2 x float> addrspace(1)* %b, i32 %1
  %5 = load <2 x float> addrspace(1)* %4, align 8, !tbaa !10
  %6 = fadd <2 x float> %3, %5
  store <2 x float> %6, <2 x float> addrspace(1)* %2, align 8, !tbaa !10
  ret void
}
