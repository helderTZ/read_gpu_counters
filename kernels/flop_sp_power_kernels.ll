; ModuleID = '/tmp/qt_temp.f11551'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024"
target triple = "spir64-unknown-unknown"

define cc76 void @scalar_dp_add_power_kernel(double addrspace(1)* nocapture %a, double addrspace(1)* nocapture %b) nounwind {
  ...
  %.pre.pre = load double addrspace(1)* %3, align 8, !tbaa !42
  br label %.preheader

.preheader:                                       ; preds = %0, %135
  %.pre = phi double [ %.pre.pre, %0 ], [ %132, %135 ]
  %k.0380 = phi i32 [ 0, %0 ], [ %136, %135 ]
  br label %5

; <label>:5                                       ; preds = %.preheader, %5
  %6 = phi double [ %.pre, %.preheader ], [ %132, %5 ]
  %j.0379 = phi i32 [ 0, %.preheader ], [ %133, %5 ]
...
define cc76 void @scalar_dp_sub_power_kernel(double addrspace(1)* nocapture %a, double addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds double addrspace(1)* %a, i64 %2
...
define cc76 void @scalar_dp_mul_power_kernel(double addrspace(1)* nocapture %a, double addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds double addrspace(1)* %a, i64 %2
...
define cc76 void @scalar_dp_div_power_kernel(double addrspace(1)* nocapture %a, double addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds double addrspace(1)* %a, i64 %2
...
define cc76 void @scalar_dp_mad_power_kernel(double addrspace(1)* nocapture %a, double addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds double addrspace(1)* %a, i64 %2
...
.preheader:                                       ; preds = %0, %135
  %.pre = phi double [ %.pre.pre, %0 ], [ %132, %135 ]
  %k.0506 = phi i32 [ 0, %0 ], [ %136, %135 ]
  br label %5

; <label>:5                                       ; preds = %.preheader, %5
  %6 = phi double [ %.pre, %.preheader ], [ %132, %5 ]
  %j.0505 = phi i32 [ 0, %.preheader ], [ %133, %5 ]
  %7 = load double addrspace(1)* %4, align 8, !tbaa !42
  ...
  store double %132, double addrspace(1)* %3, align 8, !tbaa !42
  %133 = add nsw i32 %j.0505, 1
  %134 = icmp slt i32 %133, 128
  br i1 %134, label %5, label %135

; <label>:135                                     ; preds = %5
  %136 = add nsw i32 %k.0506, 1
  %137 = icmp slt i32 %136, 100000
  br i1 %137, label %.preheader, label %138
...
define cc76 void @vect2_dp_add_power_64_kernel(<2 x double> addrspace(1)* nocapture %a, <2 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <2 x double> addrspace(1)* %a, i64 %2
  %4 = getelementptr inbounds <2 x double> addrspace(1)* %b, i64 %2
  %.pre.pre = load <2 x double> addrspace(1)* %3, align 16, !tbaa !43
  br label %.preheader

.preheader:                                       ; preds = %0, %135
  %.pre = phi <2 x double> [ %.pre.pre, %0 ], [ %132, %135 ]
  %k.0380 = phi i32 [ 0, %0 ], [ %136, %135 ]
  br label %5

; <label>:5                                       ; preds = %.preheader, %5
  %6 = phi <2 x double> [ %.pre, %.preheader ], [ %132, %5 ]
  %j.0379 = phi i32 [ 0, %.preheader ], [ %133, %5 ]
...
define cc76 void @vect2_dp_sub_power_64_kernel(<2 x double> addrspace(1)* nocapture %a, <2 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <2 x double> addrspace(1)* %a, i64 %2
...
define cc76 void @vect2_dp_mul_power_64_kernel(<2 x double> addrspace(1)* nocapture %a, <2 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <2 x double> addrspace(1)* %a, i64 %2
...
define cc76 void @vect2_dp_div_power_64_kernel(<2 x double> addrspace(1)* nocapture %a, <2 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <2 x double> addrspace(1)* %a, i64 %2
...
define cc76 void @vect2_dp_mad_power_64_kernel(<2 x double> addrspace(1)* nocapture %a, <2 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <2 x double> addrspace(1)* %a, i64 %2
...
define cc76 void @vect4_dp_add_power_64_kernel(<4 x double> addrspace(1)* nocapture %a, <4 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <4 x double> addrspace(1)* %a, i64 %2
  %4 = getelementptr inbounds <4 x double> addrspace(1)* %b, i64 %2
  %.pre.pre = load <4 x double> addrspace(1)* %3, align 32, !tbaa !43
  br label %.preheader

.preheader:                                       ; preds = %0, %135
  %.pre = phi <4 x double> [ %.pre.pre, %0 ], [ %132, %135 ]
  %k.0380 = phi i32 [ 0, %0 ], [ %136, %135 ]
  br label %5

; <label>:5                                       ; preds = %.preheader, %5
  %6 = phi <4 x double> [ %.pre, %.preheader ], [ %132, %5 ]
  %j.0379 = phi i32 [ 0, %.preheader ], [ %133, %5 ]
...
define cc76 void @vect4_dp_sub_power_64_kernel(<4 x double> addrspace(1)* nocapture %a, <4 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <4 x double> addrspace(1)* %a, i64 %2
...
define cc76 void @vect4_dp_mul_power_64_kernel(<4 x double> addrspace(1)* nocapture %a, <4 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <4 x double> addrspace(1)* %a, i64 %2
...
define cc76 void @vect4_dp_div_power_64_kernel(<4 x double> addrspace(1)* nocapture %a, <4 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <4 x double> addrspace(1)* %a, i64 %2
...
define cc76 void @vect4_dp_mad_power_64_kernel(<4 x double> addrspace(1)* nocapture %a, <4 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <4 x double> addrspace(1)* %a, i64 %2
...
define cc76 void @vect8_dp_add_power_64_kernel(<8 x double> addrspace(1)* nocapture %a, <8 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <8 x double> addrspace(1)* %a, i64 %2
  %4 = getelementptr inbounds <8 x double> addrspace(1)* %b, i64 %2
  %.pre.pre = load <8 x double> addrspace(1)* %3, align 64, !tbaa !43
  br label %.preheader

.preheader:                                       ; preds = %0, %135
  %.pre = phi <8 x double> [ %.pre.pre, %0 ], [ %132, %135 ]
  %k.0380 = phi i32 [ 0, %0 ], [ %136, %135 ]
  br label %5

; <label>:5                                       ; preds = %.preheader, %5
  %6 = phi <8 x double> [ %.pre, %.preheader ], [ %132, %5 ]
  %j.0379 = phi i32 [ 0, %.preheader ], [ %133, %5 ]
...
define cc76 void @vect8_dp_sub_power_64_kernel(<8 x double> addrspace(1)* nocapture %a, <8 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <8 x double> addrspace(1)* %a, i64 %2
...
define cc76 void @vect8_dp_mul_power_64_kernel(<8 x double> addrspace(1)* nocapture %a, <8 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <8 x double> addrspace(1)* %a, i64 %2
...
define cc76 void @vect8_dp_div_power_64_kernel(<8 x double> addrspace(1)* nocapture %a, <8 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <8 x double> addrspace(1)* %a, i64 %2
...
define cc76 void @vect8_dp_mad_power_64_kernel(<8 x double> addrspace(1)* nocapture %a, <8 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <8 x double> addrspace(1)* %a, i64 %2
...
define cc76 void @vect16_dp_add_power_64_kernel(<16 x double> addrspace(1)* nocapture %a, <16 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <16 x double> addrspace(1)* %a, i64 %2
  %4 = getelementptr inbounds <16 x double> addrspace(1)* %b, i64 %2
  %.pre.pre = load <16 x double> addrspace(1)* %3, align 128, !tbaa !43
  br label %.preheader

.preheader:                                       ; preds = %0, %135
  %.pre = phi <16 x double> [ %.pre.pre, %0 ], [ %132, %135 ]
  %k.0380 = phi i32 [ 0, %0 ], [ %136, %135 ]
  br label %5

; <label>:5                                       ; preds = %.preheader, %5
  %6 = phi <16 x double> [ %.pre, %.preheader ], [ %132, %5 ]
  %j.0379 = phi i32 [ 0, %.preheader ], [ %133, %5 ]
...
define cc76 void @vect16_dp_sub_power_64_kernel(<16 x double> addrspace(1)* nocapture %a, <16 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <16 x double> addrspace(1)* %a, i64 %2
...
define cc76 void @vect16_dp_mul_power_64_kernel(<16 x double> addrspace(1)* nocapture %a, <16 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <16 x double> addrspace(1)* %a, i64 %2
...
define cc76 void @vect16_dp_div_power_64_kernel(<16 x double> addrspace(1)* nocapture %a, <16 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <16 x double> addrspace(1)* %a, i64 %2
...
define cc76 void @vect16_dp_mad_power_64_kernel(<16 x double> addrspace(1)* nocapture %a, <16 x double> addrspace(1)* nocapture %b) nounwind {
  %1 = tail call cc75 i64 @_Z13get_global_idj(i32 0) nounwind readnone
  %sext = shl i64 %1, 32
  %2 = ashr exact i64 %sext, 32
  %3 = getelementptr inbounds <16 x double> addrspace(1)* %a, i64 %2
...
!0 = metadata !{void (double addrspace(1)*, double addrspace(1)*)* @scalar_dp_add_power_kernel, metadata !1, metadata !2, metadata !3, metadata !4, metadata !5, metadata !6}
...
!7 = metadata !{void (double addrspace(1)*, double addrspace(1)*)* @scalar_dp_sub_power_kernel, metadata !1, metadata !2, metadata !3, metadata !4, metadata !5, metadata !6}
!8 = metadata !{void (double addrspace(1)*, double addrspace(1)*)* @scalar_dp_mul_power_kernel, metadata !1, metadata !2, metadata !3, metadata !4, metadata !5, metadata !6}
!9 = metadata !{void (double addrspace(1)*, double addrspace(1)*)* @scalar_dp_div_power_kernel, metadata !1, metadata !2, metadata !3, metadata !4, metadata !5, metadata !6}
!10 = metadata !{void (double addrspace(1)*, double addrspace(1)*)* @scalar_dp_mad_power_kernel, metadata !1, metadata !2, metadata !3, metadata !4, metadata !5, metadata !6}
!11 = metadata !{void (<2 x double> addrspace(1)*, <2 x double> addrspace(1)*)* @vect2_dp_add_power_64_kernel, metadata !1, metadata !2, metadata !12, metadata !4, metadata !13, metadata !6}
...
!14 = metadata !{void (<2 x double> addrspace(1)*, <2 x double> addrspace(1)*)* @vect2_dp_sub_power_64_kernel, metadata !1, metadata !2, metadata !12, metadata !4, metadata !13, metadata !6}
!15 = metadata !{void (<2 x double> addrspace(1)*, <2 x double> addrspace(1)*)* @vect2_dp_mul_power_64_kernel, metadata !1, metadata !2, metadata !12, metadata !4, metadata !13, metadata !6}
!16 = metadata !{void (<2 x double> addrspace(1)*, <2 x double> addrspace(1)*)* @vect2_dp_div_power_64_kernel, metadata !1, metadata !2, metadata !12, metadata !4, metadata !13, metadata !6}
!17 = metadata !{void (<2 x double> addrspace(1)*, <2 x double> addrspace(1)*)* @vect2_dp_mad_power_64_kernel, metadata !1, metadata !2, metadata !12, metadata !4, metadata !13, metadata !6}
!18 = metadata !{void (<4 x double> addrspace(1)*, <4 x double> addrspace(1)*)* @vect4_dp_add_power_64_kernel, metadata !1, metadata !2, metadata !19, metadata !4, metadata !20, metadata !6}
...
!21 = metadata !{void (<4 x double> addrspace(1)*, <4 x double> addrspace(1)*)* @vect4_dp_sub_power_64_kernel, metadata !1, metadata !2, metadata !19, metadata !4, metadata !20, metadata !6}
!22 = metadata !{void (<4 x double> addrspace(1)*, <4 x double> addrspace(1)*)* @vect4_dp_mul_power_64_kernel, metadata !1, metadata !2, metadata !19, metadata !4, metadata !20, metadata !6}
!23 = metadata !{void (<4 x double> addrspace(1)*, <4 x double> addrspace(1)*)* @vect4_dp_div_power_64_kernel, metadata !1, metadata !2, metadata !19, metadata !4, metadata !20, metadata !6}
!24 = metadata !{void (<4 x double> addrspace(1)*, <4 x double> addrspace(1)*)* @vect4_dp_mad_power_64_kernel, metadata !1, metadata !2, metadata !19, metadata !4, metadata !20, metadata !6}
!25 = metadata !{void (<8 x double> addrspace(1)*, <8 x double> addrspace(1)*)* @vect8_dp_add_power_64_kernel, metadata !1, metadata !2, metadata !26, metadata !4, metadata !27, metadata !6}
...
!28 = metadata !{void (<8 x double> addrspace(1)*, <8 x double> addrspace(1)*)* @vect8_dp_sub_power_64_kernel, metadata !1, metadata !2, metadata !26, metadata !4, metadata !27, metadata !6}
!29 = metadata !{void (<8 x double> addrspace(1)*, <8 x double> addrspace(1)*)* @vect8_dp_mul_power_64_kernel, metadata !1, metadata !2, metadata !26, metadata !4, metadata !27, metadata !6}
!30 = metadata !{void (<8 x double> addrspace(1)*, <8 x double> addrspace(1)*)* @vect8_dp_div_power_64_kernel, metadata !1, metadata !2, metadata !26, metadata !4, metadata !27, metadata !6}
!31 = metadata !{void (<8 x double> addrspace(1)*, <8 x double> addrspace(1)*)* @vect8_dp_mad_power_64_kernel, metadata !1, metadata !2, metadata !26, metadata !4, metadata !27, metadata !6}
!32 = metadata !{void (<16 x double> addrspace(1)*, <16 x double> addrspace(1)*)* @vect16_dp_add_power_64_kernel, metadata !1, metadata !2, metadata !33, metadata !4, metadata !34, metadata !6}
...
!35 = metadata !{void (<16 x double> addrspace(1)*, <16 x double> addrspace(1)*)* @vect16_dp_sub_power_64_kernel, metadata !1, metadata !2, metadata !33, metadata !4, metadata !34, metadata !6}
!36 = metadata !{void (<16 x double> addrspace(1)*, <16 x double> addrspace(1)*)* @vect16_dp_mul_power_64_kernel, metadata !1, metadata !2, metadata !33, metadata !4, metadata !34, metadata !6}
!37 = metadata !{void (<16 x double> addrspace(1)*, <16 x double> addrspace(1)*)* @vect16_dp_div_power_64_kernel, metadata !1, metadata !2, metadata !33, metadata !4, metadata !34, metadata !6}
!38 = metadata !{void (<16 x double> addrspace(1)*, <16 x double> addrspace(1)*)* @vect16_dp_mad_power_64_kernel, metadata !1, metadata !2, metadata !33, metadata !4, metadata !34, metadata !6}
